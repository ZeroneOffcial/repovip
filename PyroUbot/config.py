...
DEVS = list(map(int, os.getenv("DEVS", "7716690774").split()))

API_ID = int(os.getenv("API_ID", "27095838"))

API_HASH = os.getenv("API_HASH", "28c51c248482f0ca68d091397e2e491b")

BOT_TOKEN = os.getenv("BOT_TOKEN", "8085087229:AAFcA1ntR6fUez1j9fb2zRAYPmMxQ2uxUpw")

OWNER_ID = int(os.getenv("OWNER_ID", "7716690774"))
