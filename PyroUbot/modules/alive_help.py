...
ᚗ start_uptime: {uptime}</blockquote>
        <blockquote><b>ZERONEULTRABOT</b></blockquote>
"""
...
async def user_help_inline(client, inline_query):
    ...
    msg = f"""<blockquote><b>ZERONEULTRABOT</b>
...
async def help_callback(client, callback_query):
    ...
    top_text = f"""<blockquote><b>ZERONEULTRABOT</b>
...
<b>ᴘʀᴇꜰɪxᴇs: {' '.join(SH)}</b></blockquote>"""
    ...
    if mod_match:
        ...
        await callback_query.edit_message_text(
            text=text 
            + '\n<u><blockquote><b>ZERONEULTRABOT</b></blockquote></u>',
            reply_markup=InlineKeyboardMarkup(button),
